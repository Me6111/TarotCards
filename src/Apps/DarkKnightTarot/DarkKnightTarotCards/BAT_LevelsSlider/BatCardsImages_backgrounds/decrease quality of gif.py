...
source_filename = "0.gif"
destination_filename = "0-resized.gif"
...
try:
  ...
  # Handle multi-frame GIFs (same logic as before)
  if img.n_frames > 1:
    ...
    resized_frames[0].save(destination_path, save_all=True, append_images=resized_frames[1:], duration=img.info['duration'], loop=img.info['loop'])
  else:
